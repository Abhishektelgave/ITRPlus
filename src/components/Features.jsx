      ...
      <section id="features" className="min-h-screen p-16 bg-gray-100 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="feature p-4 bg-white rounded-lg shadow-lg">
            <img src="/ITRPlus/technical-support.svg" alt="In-house CAs" className="feature-svg w-12 h-12 mx-auto mb-4" />
          ...
          <div className="feature p-4 bg-white rounded-lg shadow-lg">
            <img src="/ITRPlus/ease.png" alt="Ease of Use" className="feature-svg w-12 h-12 mx-auto mb-4 bg-transparent" />
          ...
          <div className="feature p-4 bg-white rounded-lg shadow-lg">
            <img src="/ITRPlus/il_794xN.4426905797_madr.webp" alt="Flexible Pricing" className="feature-svg w-12 h-12 mx-auto mb-4" />
        ...
        <img src="/ITRPlus/6451f51dfd81da0862dbfdd5_featureform Feature Engineering Guide-01.png" alt="Features Graphic" className="w-3/5 mx-auto mt-12 rounded-lg shadow-lg" />
      </section>
    );
  };
